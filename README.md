...
| executors-plugin        | `java.util.concurrent.AbstractExecutorService` exclude (`java.util.concurrent.ScheduledExecutorService`) | -                         | -              |
...
3. Build plugins:
   - Exec `sh packageJars.sh` yields: 
      ...
      - executors-plugin
4. Copy the `dist/*.jar` to skywalking plugins folder
