...
object Constants:
   ...
   */
  final val REQUEST_ON_CANCEL_OPERATION_NAME = "/Request/onCancel"
   ...
   */
  final val REQUEST_ON_MESSAGE_OPERATION_NAME = "/Request/onMessage"

  /** Operation name for request completed all message sending. <p> However, the call may still be cancelled.
   */
  final val REQUEST_ON_HALF_CLOSE_OPERATION_NAME = "/Request/onHalfClose"
   ...
   */
  final val REQUEST_ON_COMPLETE_OPERATION_NAME = "/Request/onComplete"

  /** Operation name for call closed with status and trailers. <p> Exceptions will be logs here.
   */
  final val RESPONSE_ON_CLOSE_OPERATION_NAME = "/Response/onClose"
   ...
   */
  final val RESPONSE_ON_MESSAGE_OPERATION_NAME = "/Response/onMessage"
